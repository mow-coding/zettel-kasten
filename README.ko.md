...
- `revert-edge`와 `revert-batch`도 v0.4.0에서는 dry-run preview만 가능하며 승인은 `compound_exact_human_approval_binding_required`로 끝나 edge나 receipt를 지우지 않습니다.
