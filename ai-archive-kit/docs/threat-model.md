...
It is not a formal penetration test. It explains what the current Archive Kit tries to prevent before a real personal or team archive touches real data.

## System Boundary

Archive Kit is the control plane.
