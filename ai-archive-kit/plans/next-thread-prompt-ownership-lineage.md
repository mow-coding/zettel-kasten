...
```text
우리는 공개 예시 경로 C:\Users\example\dev\zettel-kasten 프로젝트에서 ai-archive-kit을 만들고 있다.
...
- ai-archive-kit/specs/archive-identity.md
- ai-archive-kit/specs/archive-lineage.md
- ai-archive-kit/plans/phase-7-ownership-transfer-plan.md
- ai-archive-kit/schemas/archive-identity.schema.json
