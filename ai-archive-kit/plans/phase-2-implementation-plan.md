...
ai-archive-kit/zettel-kasten/types.yml
...
```text
The generated index is ignored by ai-archive-kit/.gitignore as **/db/archive-index.sqlite.
```
...
ai-archive-kit/plans/phase-2-implementation-plan.md
ai-archive-kit/docs/phase-2-quickstart.md
...
```powershell
$env:PYTHONPATH = "src"
python -m ai_archive_kit.archive_cli doctor examples\fake-life-archive --strict
...
```text
ai-archive-kit is the toolkit/protocol folder.
