...
v0.3.318 responds to protected Client feedback Letter 131. The source letter
was read without changing the Client archive. No real PAT, Notion account,
...
clipboard API, provider, Credential Manager, or Client data; emits no private
...
- separately run any desired fixed-synthetic human host acceptance, without a
  real PAT or Client data, and record only bounded result fields.
