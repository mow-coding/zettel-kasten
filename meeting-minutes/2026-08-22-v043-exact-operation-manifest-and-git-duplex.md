...
worktree and did not write the protected Client archive. It extends the
...
Live read-only Client measurements changed the implementation order. Raw Git
...
this was read-only and performed no Client mutation.
