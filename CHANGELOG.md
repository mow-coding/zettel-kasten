...
Fixes from v0.3.2 upgrade field feedback (<client> operator):
...
- <client>/live archives, provider sync, staged-original deletion, MCP write tools, ZET transport, and schema redesign are not part of this release.
