...
- Added read-only CLI `archive provider-status --dry-run` to compare setup-managed GitHub/object-storage provider metadata with local provider setup receipts without provider calls, uploads, sync, pushes, or file writes.
