...
```text
v0.3.199 pre-release
```

Previous public baseline: v0.3.198 pre-release.
...
- object-storage doctor now accepts same-key `skipped_remote_same` coverage and offers approval-gated `object-storage-wom-location-reconcile` for genuine missing `wom_uploaded` manifest bindings,
