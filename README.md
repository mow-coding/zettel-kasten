...
- read-only credential reference planning, inventory, external store recommendation, future access broker planning, approval receipt preview, and adapter readiness planning for mail, OpenAI API, OCR API, provider, object storage, and backup secrets,
