...
- read-only IMAP mailbox source planning, operation request packaging, adapter manifest previews, adapter readiness checks, mailbox selection planning, and adapter audit receipt previews for Gmail, Naver, and generic IMAP account refs,
