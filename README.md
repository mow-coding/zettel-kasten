...
```text
v0.3.268 pre-release
```

Previous public baseline: v0.3.267 pre-release.
...
```powershell
uv tool install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.268/wom_kit-0.3.268-py3-none-any.whl"
archive --version
```
...
- read-only `archive zet-title-remap-plan --dry-run` for human-reviewed repair proposals when imported titles are identifier-shaped; v0.3.268 accepts up to 2,000 Unicode characters, separates line breaks from other non-normalized whitespace, reports fixed safety-rule names without matched values, allows ordinary public citation URLs with a warning, and documents `basis: human_written`, while approved title write, receipts, audit, recovery, and revert remain unimplemented,
