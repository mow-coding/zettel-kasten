...
- read-only derived-text coverage/toolchain/agent-contract gates plus approval-gated single-file and JSONL batch derived text capture for registering already extracted parser/OCR/ASR/vision text against source objets,
