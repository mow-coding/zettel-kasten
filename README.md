...
Previous public baseline: v0.3.201 pre-release.
...
- `ai-response-concept-guide --topic operator_vocabulary --locale ko-KR`, a read-only Korean-first vocabulary layer for AI operators that translates common WOM terms such as `ai_start_here`, `zet`, `objet`, `receipt`, `mint`, `doctor`, `tie`, and `credential_ref` into beginner-facing phrases before jargon is shown,
