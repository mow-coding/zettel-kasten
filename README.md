...
- read-only credential reference planning, inventory, and external store recommendation for mail, OpenAI API, OCR API, provider, object storage, and backup secrets,
