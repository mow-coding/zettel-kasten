...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.41/wom_kit-0.4.41-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.40.", readme)
        self.assertIn("이전 공개 기준: v0.4.40.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            ...
            "sha256:422e5d5f8098f17108c68af4b2be30ba2f8aa05efcc8e4eb1931b58e5311fb46",
        )
