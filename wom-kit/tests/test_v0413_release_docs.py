...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.30/wom_kit-0.4.30-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.29.", readme)
        self.assertIn("이전 공개 기준: v0.4.29.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            policy["supply_lock"],
            "wom-kit/project-runtime-supply-lock-v0.4.30.json",
        )
        self.assertEqual(
            policy["supply_lock_sha256"],
            "sha256:0bf6b825372453d12012abfca2914069c6a4d2f0f3524a4c33a3957ed304437c",
        )
