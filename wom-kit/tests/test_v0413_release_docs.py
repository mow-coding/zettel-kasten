...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.45/wom_kit-0.4.45-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.44.", readme)
        self.assertIn("이전 공개 기준: v0.4.44.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            policy["supply_lock"],
            "wom-kit/project-runtime-supply-lock-v0.4.45.json",
        )
        self.assertEqual(
            policy["supply_lock_sha256"],
            "sha256:72b12d1439a660382fa02ea31360f3b27e72dcc3838de75118ed4630e884bb99",
        )
