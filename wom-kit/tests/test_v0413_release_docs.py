...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.35/wom_kit-0.4.35-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.34.", readme)
        self.assertIn("이전 공개 기준: v0.4.34.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            policy["supply_lock"],
            "wom-kit/project-runtime-supply-lock-v0.4.35.json",
        )
        self.assertEqual(
            policy["supply_lock_sha256"],
            "sha256:e9df89a73ffaed90442329dd9bb0527d5f6045cc1d57d9e013473d635a1bf814",
        )
