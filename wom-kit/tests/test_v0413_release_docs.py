...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.29/wom_kit-0.4.29-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.28.", readme)
        self.assertIn("이전 공개 기준: v0.4.28.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            policy["supply_lock"],
            "wom-kit/project-runtime-supply-lock-v0.4.29.json",
        )
        self.assertEqual(
            policy["supply_lock_sha256"],
            "sha256:a5f94771af0f44274bcdd34ee5295a4b16eeb4b45b298c42fd6dfad9ca7c4e68",
        )
