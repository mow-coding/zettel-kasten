...
class V0413ReleaseDocsTests(unittest.TestCase):
    def test_v0413_is_preserved_as_source_history(self) -> None:
        ...
        for document in (readme, readme_ko):
            self.assertIn("releases/download/v0.4.27/wom_kit-0.4.27-py3-none-any.whl", document)
        self.assertIn("Previous public baseline: v0.4.26.", readme)
        self.assertIn("이전 공개 기준: v0.4.26.", readme_ko)
    ...
    def test_v0413_supply_lock_is_historical_and_current_policy_is_v0419(self) -> None:
        ...
        self.assertEqual(
            ...
            "sha256:6fc8683afd197c82866d023a6faa4416f46ded9f922d5ad9f679d6b33dc1f916",
        )
