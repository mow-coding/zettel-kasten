...
PACKAGED_RELEASE = RESOURCE_ROOT / "release-notes" / "v0.4.16.md"
...
POLICY_SHA256 = "eb0ca43799b850022cf64f1a23bf44f493bbdf59266d84f6b46f5a1590127364"
BOOTSTRAP_DOCUMENTS = (
    ROOT / "README.md",
    ROOT / "README.ko.md",
    ROOT / "UPGRADE.md",
    ...
    def test_current_install_guides_use_new_exact_pip_bootstrap(self) -> None:
        for path in BOOTSTRAP_DOCUMENTS:
            ...
            with self.subTest(path=path):
                ...
                self.assertIn("wom_kit-0.4.16-py3-none-any.whl", document)
                self.assertIn(
