...
class InstalledEntrypointTests(unittest.TestCase):
    ...
    def test_installed_wheel_direct_url_retains_exact_pip_hash(self) -> None:
        python = self.scripts / "python.exe"
        wheel = self.temp_root / "wom_kit-0.4.46-py3-none-any.whl"
...
class InstalledRuntimeJourneyHookTests(unittest.TestCase):
    def setUp(self):
        ...
        self.wheel = self.root / "wom_kit-0.4.46-py3-none-any.whl"
    ...
    def test_partial_runtime_evidence_accepts_canonical_beta_but_keeps_proof_checks(self):
        evidence = {**self.evidence, "package_version": "0.4.46b1"}
        ...
        for version in ("0.4.46b0", "0.4.46b01", "0.4.46-beta.1", "0.4.46b1/private", "0.4.46b" + "1" * 65):
