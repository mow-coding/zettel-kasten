...
EXPECTED_CURRENT_VERSION = "0.4.42"
...
CURRENT_RUNTIME_STATUS = f"Status: {CURRENT_VERSION} whole IMAP messages with their attachments kept under one approval"
        ...
        for text in (readme_text, readme_ko_text):
            with self.subTest(document="root-readme-on-ramp"):
                ...
                root_line = (
                    ...
                    '"WOM\\bootstrap-v0442-$womBootstrapNonce"'
                )
