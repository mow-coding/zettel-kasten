...
EXPECTED_CURRENT_VERSION = "0.4.45"
...
CURRENT_RUNTIME_STATUS = f"Status: {CURRENT_VERSION} a twelve-rule core card and intent table for the helper AI, with model and reasoning guidance"
        ...
        for text in (readme_text, readme_ko_text):
            with self.subTest(document="root-readme-on-ramp"):
                ...
                root_line = (
                    ...
                    '"WOM\\bootstrap-v0445-$womBootstrapNonce"'
                )
