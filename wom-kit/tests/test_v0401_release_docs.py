...
class V0401ReleaseDocsTests(unittest.TestCase):
    ...
    def test_current_parser_combines_all_released_writers(self) -> None:
        ...
        self.assertEqual(len(blocked), 24)  # v0.4.40: 2026-09-24 triage
        ...
        self.assertEqual(counts["approval_available_command_count"], 82)  # v0.4.40: 2026-09-24 triage
        self.assertEqual(counts["approval_fixed_closed_command_count"], 25)
