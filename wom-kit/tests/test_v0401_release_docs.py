...
class V0401ReleaseDocsTests(unittest.TestCase):
    ...
    def test_current_parser_combines_all_released_writers(self) -> None:
        ...
        self.assertEqual(counts["canonical_executable_command_count"], 322)  # v0.4.37: operator-feedback-archive
        ...
        self.assertEqual(counts["approval_available_command_count"], 61)  # v0.4.37: operator-feedback-archive
