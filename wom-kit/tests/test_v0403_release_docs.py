...
CURRENT_RELEASE_PATH = KIT / "docs" / "releases" / "v0.4.11.md"
CURRENT_PACKAGED_RELEASE_PATH = RESOURCE_ROOT / "release-notes" / "v0.4.11.md"
...
class V0408AndCurrentReleaseDocsTests(unittest.TestCase):
    def test_current_install_bootstrap_uses_one_exact_release_version(self) -> None:
        ...
        self.assertIn("exactly `archive 0.4.11`", install)
        self.assertIn("정확히 `archive 0.4.11`", install_ko)
    ...
    def test_version_sources_and_wheel_contract_are_synchronized(self) -> None:
        self.assertEqual(__version__, "0.4.11")
        self.assertIn(
            'version = "0.4.11"',
        ...
        self.assertIn('version: "0.4.11"', citation)
    ...
    def test_current_release_and_resources_are_packaged_exactly(self) -> None:
        ...
        self.assertEqual(release_names, ["v0.4.11.md"])
        ...
        self.assertIn("release-notes/v0.4.11.md", packaged_paths)
    ...
    def test_v0411_release_defines_current_scope_and_privacy_boundaries(self) -> None:
