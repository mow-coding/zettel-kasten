...
class V0433ReleaseDocsTests(unittest.TestCase):
    ...
    def test_supply_lock_and_policy_are_exact(self) -> None:
        ...
        self.assertEqual(previous.replace(b'"target_tag": "v0.4.32"', b'"target_tag": "v0.4.33"'), current)
    ...
    def test_release_surfaces_are_documented(self) -> None:
        ...
        self.assertIn("60 approval-available, 59 fixed-closed", " ".join(approval.split()))
