...
class WorkSessionCommandModeTests(unittest.TestCase):
    def test_complete_boolean_matrix_has_only_the_fourteen_explicit_inputs(self):
        ...
        for action in ("list", "inspect", "request-init", "register-app", "create", "claim"):
    ...
    def test_defaults_are_queries_only_and_create_dry_run_is_not_invented(self):
        ...
        for action in ("register-app", "create", "claim"):
    ...
    def test_future_unknown_alias_and_private_actions_are_fixed_unavailable(self):
        for action in ("pause", "resume", "handoff", "accept", "complete", "recover",
