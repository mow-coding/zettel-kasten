...
class V0430ReleaseDocsTests(unittest.TestCase):
    ...
    def test_supply_lock_and_policy_are_exact(self) -> None:
        ...
        self.assertEqual(previous.replace(b'"target_tag": "v0.4.30"', b'"target_tag": "v0.4.39"'), current)
    ...
    def test_release_surfaces_are_documented(self) -> None:
        ...
        self.assertEqual(coverage["paths"]["exact-approval-claim-finalize"]["status"], "session_integrated")  # v0.4.36: environment route
