...
CURRENT_RESOURCE_COUNT = 174
CURRENT_RESOURCE_CANONICAL_SHA256 = (
    "3479df292a82958db0d9431430290147b5443e11c7e8875dd65c1a9e72a58d1c"
)
...
class V03299PredecessorSurfaceTests(unittest.TestCase):
    ...
    def test_resource_paths_are_v03297_plus_exact_through_v0419_delta(self) -> None:
        ...
        self.assertEqual(
            ...
            "the exact cumulative v0.3.298 through v0.4.37 delta. "
    ...
    def test_v0419_release_note_is_current_and_older_notes_remain_historical(self) -> None:
        current_source_release = KIT_ROOT / "docs" / "releases" / "v0.4.37.md"
        ...
        for token in (
            ...
            "wom_kit-0.4.37-py3-none-any.whl",
        ):
