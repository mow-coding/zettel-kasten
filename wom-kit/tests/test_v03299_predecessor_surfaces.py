...
CURRENT_RESOURCE_CANONICAL_SHA256 = (
    "64737e9e24ba0cb0c89126b684cffa1697b6bcb68ea1920a7d827ec7b6cf39db"
)
...
class V03299PredecessorSurfaceTests(unittest.TestCase):
    ...
    def test_resource_paths_are_v03297_plus_exact_through_v0417_delta(self) -> None:
        ...
        self.assertEqual(
            ...
            "the exact cumulative v0.3.298 through v0.4.17 delta. "
    ...
    def test_v0417_release_note_is_current_and_older_notes_remain_historical(self) -> None:
        current_source_release = KIT_ROOT / "docs" / "releases" / "v0.4.17.md"
        ...
        for token in (
            ...
            "wom_kit-0.4.17-py3-none-any.whl",
        ):
