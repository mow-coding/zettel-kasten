...
RESOURCE_ADDITIONS = {
    ...
    "schemas/approval-integrity-audit-result-v0.2.schema.json",
    "schemas/exact-human-approval-claim-finalize-receipt-v0.1.schema.json",
...
CURRENT_RESOURCE_CANONICAL_SHA256 = (
    "173fe9dc018a258c26fe13bacfa0f194cf9e47ac7f180bcd473dba8995db9fb0"  # v0.4.46 resources (release note only)
)
...
class V03299PredecessorSurfaceTests(unittest.TestCase):
    ...
    def test_resource_paths_are_v03297_plus_exact_through_v0419_delta(self) -> None:
        ...
        self.assertEqual(
            ...
            "the exact cumulative v0.3.298 through v0.4.46 delta. "
    ...
    def test_v0419_release_note_is_current_and_older_notes_remain_historical(self) -> None:
        current_source_release = KIT_ROOT / "docs" / "releases" / "v0.4.46.md"
        ...
        for token in (
            ...
            "wom_kit-0.4.46-py3-none-any.whl",
        ):
        ...
        v0414_source_release = KIT_ROOT / "docs" / "releases" / "v0.4.14.md"
        v0414_packaged_release = current_packaged_release.with_name("v0.4.14.md")
        self.assertTrue(v0414_source_release.is_file())
        self.assertFalse(v0414_packaged_release.exists())
