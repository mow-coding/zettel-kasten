...
RUNTIME_PHASE_LIMIT_MS = 2_400_000
...
def _check_installed_v0419_runtime_journey(
    ...
    try:
        stdout = _run_installed_entrypoint(
            ...
            cwd=cwd, label="installed v0.4.19 real runtime journey", timeout_seconds=2400,
...
def _validate_v0419_runtime_evidence(
    ...
    if (
        ...
        or any(type(value) not in {int, float} or not 0 <= value <= 2400 for value in seconds.values())
