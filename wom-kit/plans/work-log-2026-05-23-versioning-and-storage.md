...
CHANGELOG.md
UPGRADE.md
wom-kit/docs/releases/README.md
wom-kit/docs/releases/v0.2.0.md
wom-kit/docs/releases/v0.2.1.md
```
...
because `wom-kit` already uses package version `0.2.0`.
...
CONTRIBUTING.md
SECURITY.md
wom-kit/docs/github-repository-strategy.md
```
...
```text
wom-kit/specs/object-manifest.md
README.md
```
