...
```text
python -m unittest wom-kit.tests.test_cli.ArchiveCliTests.test_delegate_zet_dry_run_previews_receipt_with_hashes wom-kit.tests.test_cli.ArchiveCliTests.test_delegate_zet_real_requires_approve_and_reviewed_by wom-kit.tests.test_cli.ArchiveCliTests.test_delegate_zet_approve_writes_real_receipt wom-kit.tests.test_cli.ArchiveCliTests.test_delegate_zet_claimable_once_approve_writes_receipt_without_target_archive wom-kit.tests.test_cli.ArchiveCliTests.test_claimable_once_attest_binds_claimant_and_anchor_preserves_claim
python -m unittest wom-kit.tests.test_mcp_server.McpServerTests.test_delegate_attest_anchor_checks_are_dry_run_only
```
...
- `wom-kit/src/wom_kit/schema_validator.py`
- `wom-kit/schemas/delegate-receipt.schema.json`
...
- `wom-kit/docs/releases/v0.2.12.md`
- `wom-kit/plans/work-log-2026-05-23-real-delegate-receipt-write.md`
