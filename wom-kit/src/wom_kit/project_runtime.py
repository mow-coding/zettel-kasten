...
def project_runtime_policy_document(raw: bytes | None) -> dict[str, Any] | None:
    ...
    expected = {
        ...
        "supply_lock": "wom-kit/project-runtime-supply-lock-v0.4.18.json",
        "supply_lock_sha256": "sha256:4be603856000aea49421dd7032b4cabd1ba967a123c17e58e215943fb060186f",
