...
def project_runtime_policy_document(raw: bytes | None) -> dict[str, Any] | None:
    ...
    expected = {
        ...
        "supply_lock": "wom-kit/project-runtime-supply-lock-v0.4.43b13.json",
        "supply_lock_sha256": "sha256:17cc142c35325aa0645700554eebbd748dfa1d82d0c4b0f6fdad2d0a9b17ebf4",
