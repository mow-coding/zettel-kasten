...
def project_runtime_policy_document(raw: bytes | None) -> dict[str, Any] | None:
    ...
    expected = {
        ...
        "supply_lock": "wom-kit/project-runtime-supply-lock-v0.4.23.json",
        "supply_lock_sha256": "sha256:76c88556b04fff5c978a0703d10c5844ef84d4029b53e8dc84e947d23bdaa628",
