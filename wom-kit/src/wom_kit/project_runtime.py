...
def project_runtime_policy_document(raw: bytes | None) -> dict[str, Any] | None:
    ...
    expected = {
        ...
        "supply_lock": "wom-kit/project-runtime-supply-lock-v0.4.42b11.json",
        "supply_lock_sha256": "sha256:f3e53bc3d4e751d0168af99a01d85add9545afa5708b33b4d2887c589a36a722",
