...
def project_runtime_policy_document(raw: bytes | None) -> dict[str, Any] | None:
    ...
    expected = {
        ...
        "supply_lock": "wom-kit/project-runtime-supply-lock-v0.4.34.json",
        "supply_lock_sha256": "sha256:5fbb5bc16d5b8ea0ddc448da65acaf77731a81f14ccf75a33eb927605617b447",
