...
| RT-05 | v0.4.19 | Operational Doctor <=180 s, initial status <=2 s, heartbeat <=10 s; count and byte-scale evidence distinguished; no background console flashes | historical count profile passed; repeated-index defect corrected and generation-barrier tests passed; genuine-twin mixed run and cold installed startup pending |
