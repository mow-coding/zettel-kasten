...
Status: v0.3.280 GitHub wheel and read-only activity-group membership planning checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.280/wom_kit-0.3.280-py3-none-any.whl"
