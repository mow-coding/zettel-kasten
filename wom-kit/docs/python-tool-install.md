...
Status: v0.3.277 GitHub wheel and read-only Notion locator-loss census checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.277/wom_kit-0.3.277-py3-none-any.whl"
