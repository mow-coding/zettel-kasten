...
Status: v0.3.254 GitHub wheel and independent-audit follow-up checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.254/wom_kit-0.3.254-py3-none-any.whl"
