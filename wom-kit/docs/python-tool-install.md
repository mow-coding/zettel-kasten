...
Status: v0.3.265 GitHub wheel and durable abstract batch journal checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.265/wom_kit-0.3.265-py3-none-any.whl"
