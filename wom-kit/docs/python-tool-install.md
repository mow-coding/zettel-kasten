...
Status: v0.4.22 conditional GitHub wheel contract; project-update failure truth and started-claim abandon
...
The v0.4.22 URL below is a conditional contract, not proof that an artifact is
public. Use it only after the matching GitHub Release exists and lists the
verified wheel. See the [v0.4.22 release note](releases/v0.4.22.md) for the
separate source and release-evidence boundary; the v0.4.19, v0.4.20 and
v0.4.21 notes remain the record of the runtime-truth, session-owned-write and
reopened-writer deltas.

An installed older runtime may not contain v0.4.22's project-update failure
...
After the new process reports exactly `archive 0.4.22`, use that explicit
