...
Status: v0.3.262 GitHub wheel and identifier-title census checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.262/wom_kit-0.3.262-py3-none-any.whl"
