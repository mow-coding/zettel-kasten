...
Status: v0.3.279 GitHub wheel and read-only inbox pipeline audit checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.279/wom_kit-0.3.279-py3-none-any.whl"
