...
Status: v0.3.286 GitHub wheel and manual-only format-variant checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.286/wom_kit-0.3.286-py3-none-any.whl"
