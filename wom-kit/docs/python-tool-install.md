...
Status: v0.4.25 conditional GitHub wheel contract; archive-root update hotfix and session permission modes
...
The v0.4.25 URL below is a conditional contract, not proof that an artifact is
public. Use it only after the matching GitHub Release exists and lists the
verified wheel. See the [v0.4.25 release note](releases/v0.4.25.md) for the
separate source and release-evidence boundary; the v0.4.19 through v0.4.24
notes remain the record of the runtime-truth, session-owned-write,
reopened-writer, update-failure, fidelity-source and permission-mode deltas.

An installed older runtime may not contain v0.4.25's archive-root update
...
After the new process reports exactly `archive 0.4.25`, use that explicit
