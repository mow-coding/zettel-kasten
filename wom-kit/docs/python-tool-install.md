...
Status: v0.3.271 GitHub wheel and read-only title recovery-plan checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.271/wom_kit-0.3.271-py3-none-any.whl"
