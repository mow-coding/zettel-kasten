...
Status: v0.3.287 GitHub wheel and read-only Notion locator evidence checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.287/wom_kit-0.3.287-py3-none-any.whl"
