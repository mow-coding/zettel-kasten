...
Status: v0.3.245 GitHub wheel and top-level installation on-ramp
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.245/wom_kit-0.3.245-py3-none-any.whl"
