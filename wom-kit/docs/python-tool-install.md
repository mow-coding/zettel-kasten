...
Status: v0.3.274 GitHub wheel and approval-gated completed-title revert checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.274/wom_kit-0.3.274-py3-none-any.whl"
