...
Status: v0.3.283 GitHub wheel and activity-group retained-journal isolation checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.283/wom_kit-0.3.283-py3-none-any.whl"
