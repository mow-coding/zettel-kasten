...
Status: v0.3.282 GitHub wheel and read-only activity-group membership removal-plan checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.282/wom_kit-0.3.282-py3-none-any.whl"
