...
The v0.4.42 URL below is a conditional contract, not proof that an artifact is
public. Use it only after the matching GitHub Release exists and lists the
verified wheel. See the [v0.4.42 release note](releases/v0.4.42.md) for the
...
After the new process reports exactly `archive 0.4.42`, use that explicit
...
& "$womToolRoot\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.4.42/wom_kit-0.4.42-py3-none-any.whl"
