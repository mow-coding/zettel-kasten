...
Status: v0.3.272 GitHub wheel and approval-gated title recovery checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.272/wom_kit-0.3.272-py3-none-any.whl"
