...
Status: v0.3.255 GitHub wheel and crash-safe index result checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.255/wom_kit-0.3.255-py3-none-any.whl"
