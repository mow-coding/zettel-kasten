...
Status: v0.3.261 GitHub wheel and honest search coverage checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.261/wom_kit-0.3.261-py3-none-any.whl"
