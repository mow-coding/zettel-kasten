...
Status: v0.3.296 GitHub wheel and reviewed private metadata writer checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.296/wom_kit-0.3.296-py3-none-any.whl"
