...
Status: v0.3.305 GitHub wheel and Letter 113 real-use completion
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.305/wom_kit-0.3.305-py3-none-any.whl"
