...
Status: v0.3.276 GitHub wheel and approval-gated title-revert recovery checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.276/wom_kit-0.3.276-py3-none-any.whl"
