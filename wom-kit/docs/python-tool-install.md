...
Status: v0.3.278 GitHub wheel and AI command-path routing checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.278/wom_kit-0.3.278-py3-none-any.whl"
