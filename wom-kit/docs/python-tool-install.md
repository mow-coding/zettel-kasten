...
Status: v0.3.281 GitHub wheel and approval-gated activity-group membership write checkpoint
...
& "$HOME\.wom-tools\wom-kit\Scripts\python.exe" -m pip install "https://github.com/mow-coding/zettel-kasten/releases/download/v0.3.281/wom_kit-0.3.281-py3-none-any.whl"
