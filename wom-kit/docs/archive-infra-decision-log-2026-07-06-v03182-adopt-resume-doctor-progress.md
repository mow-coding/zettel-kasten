...
The <client> v0.3.180 revalidation showed that the v0.3.180 adopt-plan manifest index worked on the
...
For <client>'s partial adopt state, the next intended retry shape is:
