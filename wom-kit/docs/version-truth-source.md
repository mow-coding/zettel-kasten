...
Current checkpoint: Status: v0.4.33 upload reopened with installed-wheel hash evidence
...
The v0.4.33 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.33` from a new process. The external CPython 3.12
