...
Current checkpoint: Status: v0.4.30 letter-163 mint gate and claim store with installed-wheel hash evidence
...
The v0.4.30 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.30` from a new process. The external CPython 3.12
