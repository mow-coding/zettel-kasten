...
Current release candidate: v0.4.41 new-user entry, working Notion recovery with trash cleanup, and seven more writers reopened; [triage decision](archive-infra-decision-log-2026-09-24-closed-writer-triage.md). The public stable baseline remains v0.4.40 until publication.

Status: v0.4.41 new-user entry, working Notion recovery with trash cleanup, seven more writers reopened
...
Current checkpoint: Status: v0.4.41 new-user entry and Notion chain candidate; installed-wheel and public evidence pending
...
The v0.4.41 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.41` from a new process. The external CPython 3.12
