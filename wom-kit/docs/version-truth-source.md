...
Status: v0.4.32 letter-164 first half, letter-163 remainder, and session-owned writes
...
Current checkpoint: Status: v0.4.32 letter-164 first half with installed-wheel hash evidence
...
The v0.4.32 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.32` from a new process. The external CPython 3.12
