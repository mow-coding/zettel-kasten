...
Current checkpoint: Status: v0.4.36 no-dialog grants with installed-wheel hash evidence
...
The v0.4.36 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.36` from a new process. The external CPython 3.12
