...
Status: v0.4.23 binary fidelity sources, session-bound drafts, and session-owned writes
...
Current checkpoint: Status: v0.4.23 binary fidelity sources and session-bound drafts with installed-wheel hash evidence
...
The v0.4.23 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.23` from a new process. The external CPython 3.12
