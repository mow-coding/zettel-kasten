...
Status: v0.4.27 client follow-ups, target-details dialog hotfix, and session-owned writes
...
Current checkpoint: Status: v0.4.27 client follow-ups with installed-wheel hash evidence
...
The v0.4.27 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.27` from a new process. The external CPython 3.12
