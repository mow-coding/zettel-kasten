...
Current release candidate: v0.4.40 closed-writer triage (27 reopened, 12 removed) and activity-scoped close; [triage decision](archive-infra-decision-log-2026-09-24-closed-writer-triage.md). The public stable baseline remains v0.4.39 until publication.

Status: v0.4.40 27 writers reopened under exact approval, 12 commands removed, activity-scoped close
...
Current checkpoint: Status: v0.4.40 closed-writer triage candidate; installed-wheel and public evidence pending
...
The v0.4.40 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.40` from a new process. The external CPython 3.12
