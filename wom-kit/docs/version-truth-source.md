...
Current checkpoint: Status: v0.4.37 session-scoped storage with installed-wheel hash evidence
...
The v0.4.37 URL is a conditional release-artifact contract. Use it only after
...
Require exactly `archive 0.4.37` from a new process. The external CPython 3.12
