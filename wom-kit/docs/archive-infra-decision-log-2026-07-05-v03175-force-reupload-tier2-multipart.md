...
gates). Never touches a real archive or `zettel-kasten-<client>`, and makes no real network
...
The <client> 5th operator letter (§3) surfaced two independent gaps that make a **live** R2
