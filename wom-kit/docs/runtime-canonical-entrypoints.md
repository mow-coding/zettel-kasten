...
Status: v0.3.288 installed-wheel resource, read-only Notion locator evidence routing, content-free MCP error boundary, quick start, session handoff, local backup evidence, and philosophy implementation traceability checkpoint
