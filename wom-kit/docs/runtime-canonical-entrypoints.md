...
When an updater bootstrap is needed and the exact public v0.4.24 GitHub Release
...
Require exactly `archive 0.4.24` from a new process. This does not update the
