...
When an updater bootstrap is needed and the exact public v0.4.35 GitHub Release
...
Require exactly `archive 0.4.35` from a new process. This does not update the
