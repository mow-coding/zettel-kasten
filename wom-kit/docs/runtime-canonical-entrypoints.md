...
When an updater bootstrap is needed and the exact public v0.4.25 GitHub Release
...
Require exactly `archive 0.4.25` from a new process. This does not update the
