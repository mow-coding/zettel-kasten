...
WOM-kit is still a local-first developer-stage toolkit, not a completed audited product. This hardening reduces obvious local blast radius before broader release.
...
system directories
WOM-kit repository root as a source
