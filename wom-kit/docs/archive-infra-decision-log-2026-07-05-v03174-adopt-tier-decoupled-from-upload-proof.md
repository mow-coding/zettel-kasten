...
after gates). Never touches a real archive or `zettel-kasten-<client>`, and makes no
...
PUT — so a store of already-present objects (the <client> 158 GB / 19,054-object
...
- **DEC-2 — Boolean adopt gate; no tier2/tier3/5 GiB/3-id vocabulary for adopt.**
  ...
  nothing real and would re-block <client>.
