...
| `EXTERNAL_LIVE_NEVER_TOUCH` | a real <client> dogfood archive, any real user archive, any real local `-objets` store | Never read or mutate by default. Require explicit operator approval. |
