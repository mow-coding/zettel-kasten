...
`archives/archive:personal:<client>/objets/<sha256>.png`. If a client's own upload
record listed each object's sha and that exact key, the JSONL WOM consumes would be:

```json
{"sha256":"<sha256-of-object-1>","remote_key":"archives/archive:personal:<client>/objets/<sha256-of-object-1>.png"}
{"sha256":"<sha256-of-object-2>","remote_key":"archives/archive:personal:<client>/objets/<sha256-of-object-2>.pdf"}
```
